...
const MovieList = () => {
  ...
  const getData = useCallback(() => { //b1a89f5ff7960aa54d49123a25d03503
    ...
    const popularLatestURL = `https://api.themoviedb.org/3/discover/${type ? type : "movie"}?api_key=b1a89f5ff7960aa54d49123a25d03503&primary_release_year=2023&sort_by=vote_average.asc`;
