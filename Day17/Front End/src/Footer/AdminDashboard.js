  ...
  return (
    <div>
      ...
      <div className="action-buttons">
        ...
        <button className="action-button" onClick={() => viewQuery("Your query content goes here.")}>
          View Query
        </button>
      </div>
      ...
      <div className='crud'>
        <button onClick={() => navigate("/crudhome")}>List1</button>
        <button onClick={() => navigate("/crudhome2")}>List2</button>
        <button onClick={() => navigate("/crudhome3")}>List3</button>
      </div>
      {showQuery && (
